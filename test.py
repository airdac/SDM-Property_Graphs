...
headers = pd.read_csv(TEMP/'dblp_article_header.csv',
...
df = pd.read_csv(TEMP/'dblp_article.csv', delimiter=";", nrows=1000000,
                 names=headers_col_names,
                 index_col=headers_col_names[0], usecols=[
                     "article", "ee", "author", "journal", "month", "year", "title", "volume", ]
                 )
